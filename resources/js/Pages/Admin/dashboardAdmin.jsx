...
export default function DashboardAdmin() {
    ...
    const RealTimeDate = () => {
        ...
        return (
            <h1>{`${dayOfWeek}, ${dayOfMonth} ${month} ${year}`}</h1>
        );
    };
            ...
            <div className='mt-[3%] mx-[5%]'>
                ...
                <div className='bg-white mt-[5%] border-2 border-gray-300'>
                    ...
                    <div className='grid grid-cols-3 py-[2%] px-[1%]'>
                        ...
                        <div className='flex items-center justify-around mx-[20%] rounded-lg'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-person-fill-x" viewBox="0 0 16 16">
