    ...
    const autoTyping = (element, text, speed) => {
        ...
        const typing = () => {
            if (isDeleting) {
                ...
                element.innerText = text.substring(0, i) + (i < text.length ? text.charAt(i) : '');
                i++;
            }
                    ...
                    <div className="flex flex-col my-4 mt-4">
                        ...
                        <Card className="py-4 mb-4">
                            <CardHeader className="pb-3 pt-2 px-4 flex flex-row items-center justify-center relative">
                                ...
                                <Button onPress={onOpen} className={`absolute left-4 bottom-4 ${isSmallScreen ? 'p-0 w-auto' : 'p-4'} ${isSmallScreen ? 'text-sm' : 'text-base'}`}>
                                  {isSmallScreen ? (
                                      <svg
                                          xmlns="http://www.w3.org/2000/svg"
                                          width="18"
